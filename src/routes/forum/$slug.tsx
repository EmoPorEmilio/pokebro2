          ...
          <div class="w-full px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-bg-300 rounded-xl p-6 border border-primary-700/30 mb-6 flex items-center justify-between">
              ...
              <Link
                to="/forum/$slug/new"
                params={{ slug: slug() }}
                class="px-4 py-2 bg-accent text-bg-400 rounded-lg font-medium hover:bg-accent/90 transition-colors shrink-0"
              >
                Crear tema
              </Link>
            </div>
  ...
  return (
    <div class="bg-bg-300 rounded-xl p-12 border border-primary-700/30 text-center">
      ...
      <Link
        ...
        class="inline-block px-4 py-2 bg-accent text-bg-400 rounded-lg font-medium hover:bg-accent/90 transition-colors"
      >
        Crear nuevo tema
      </Link>
    </div>
